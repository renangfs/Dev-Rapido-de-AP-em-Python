...
def Ler(): 
    ...
    try:
        ...
        msgE2=Label(app, text=erro,bg="white",fg="red",font="consolas 20",anchor=W).place(x=20,y=280,width=950,height=20)#Esolha da operação
...
def Excluir():
    fr_quadro2=Frame(app, borderwidth=1,relief="solid",background="#dde")
    fr_quadro2.place(x=0,y=0,width=1020,height=720)
    if os.path.exists("C:\\Users\\renan\\Desktop\\pasta\\teste.txt"):
        os.remove("C:\\Users\\renan\\Desktop\\pasta\\teste.txt")
        msgE1=Label(app, text="Arquivo Removido!",bg="#dde",fg="green",font="consolas 15",anchor=W).place(x=370,y=260,width=400,height=20)#Esolha da operação
    else:
